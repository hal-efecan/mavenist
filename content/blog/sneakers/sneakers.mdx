...
<Instagram instagramId="BGtylyArieE" />
<ShopBtn text={`Shop`} url={`https://amzn.to/2A4IKpe`} />
...
<Instagram instagramId="BGEpFFarie2" />
<ShopBtn text={`Shop`} url={`https://amzn.to/2ATO673`} />
...
<Instagram instagramId="B2ZVoCEhvIw" />
<ShopBtn text={`Shop`} url={`https://amzn.to/2XeVt08`} />
...
<Instagram instagramId="B_cl5Ouq7PI" />
<ShopBtn text={`Shop`} url={`https://amzn.to/2XmXLdN`} />
...
<Instagram instagramId="BmyepFegWhl" />
<ShopBtn text={`Shop`} url={`https://amzn.to/3genSMK`} />
